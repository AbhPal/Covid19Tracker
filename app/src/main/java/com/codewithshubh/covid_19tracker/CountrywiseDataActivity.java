...
import com.codewithshubh.covid_19tracker.Adapters.CountrywiseAdapter;
...
public class CountrywiseDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.activity_countrywise_recyclerview);
        swipeRefreshLayout = findViewById(R.id.activity_countrywise_refresh);
        search = findViewById(R.id.activity_countrywise_search_editText);
    ...
    public void onItemClick(int position) {
        Intent perCountryIntent = new Intent(this, EachCountryActivity.class);
